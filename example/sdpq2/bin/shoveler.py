...
import sdpq2
from sdpq2.utils import SignalHandler, unload_module, dataset_to_instrument
...
def main(n, sleep_time):
    unload_module('sdpq2.plugins')
    import sdpq2.plugins as plugins
...
if(__name__ == '__main__'):
    from sdpq2.utils import monitor, get_plugin_dir
